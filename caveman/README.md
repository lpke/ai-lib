...
- `lite`: default caveman style, tight professional prose, keeps articles and full sentences.
- `full`: compressed caveman style, drops articles and allows fragments.
